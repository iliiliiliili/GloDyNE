...
if __name__ == '__main__':
    # --- load data ---
    df = pd.read_csv('HepPh.txt', sep=' \t| ', names=['from','to','weight?','time'], header=None, comment='%')
    ...
    for i in range(len(df['time'])):    # for each ith line
        if tmp == df['time'][i]:        # if is in current day at ith line
            ...
            cnt_graphs += 1
            if (tmp == 19990131 or tmp == 19990228 or tmp == 19990331 or tmp == 19990430 or tmp == 19990531 or tmp == 19990630 or 
                tmp == 19990731 or tmp == 19990831 or tmp == 19990930 or tmp == 19991031 or tmp == 19991130 or tmp == 19991231 or 
                tmp == 19980131 or tmp == 19980228 or tmp == 19980331 or tmp == 19980430 or tmp == 19980531 or tmp == 19980630 or 
                tmp == 19980731 or tmp == 19980831 or tmp == 19980930 or tmp == 19981031 or tmp == 19981130 or tmp == 19981231):
